<template>
  <div class="battledev2019_novembre">
      ...
      <v-tab-item>
        <v-card class="mx-auto my-12" max-width="75%">
          <v-card-title class="text-h4 mb-1">
            👉 Cherche classement complet novembre 2019 (y a que les 25 premiers ici)
          </v-card-title>
          <v-card-text>
            Si tu as le classement complet novembre 2019, fait un pull request sur `/public/static/battledev2019Nov_score.json` ou ouvre une issue sur le <a target="_blank" href="https://github.com/cbarange/Battledev_ScoreboardTify/issues"> github </a> en mettant le lien vers le classement 👏
          </v-card-text>
        </v-card>
...
<script>
  import battledev2019_score from '../../public/static/battledev2019Nov_score.json'  
  import score_table from '../components/score_table'  

  export default {
    name:'battledev2019_novembre',
