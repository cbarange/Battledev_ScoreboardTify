      ...
      <v-tab-item>
        <v-card class="mx-auto my-12" max-width="75%">
          <v-card-title class="text-h4 mb-1">
            👉 Cherche classement complet mars 2020 (y a que les 25 premiers ici)
          </v-card-title>
          <v-card-text>
            Si tu as le classement complet mars 2020, fait un pull request sur `/public/static/battledev2020Mars_score.json` ou ouvre une issue sur le <a target="_blank" href="https://github.com/cbarange/Battledev_ScoreboardTify/issues"> github </a> en mettant le lien vers le classement 👏
          </v-card-text>
        </v-card>
...
<script>
  import battledev2020_score from '../../public/static/battledev2020Mars_score.json'  
  import score_table from '../components/score_table'  

  export default {
    name:'battledev2020_mars',
    ...
    data: () => {
      return {
        ...
        scoreboard: battledev2020_score,
        title:`BattleDev 2020 Saison ${battledev2020_score.edition} Scoreboard`
      }
    },
  }
</script>
